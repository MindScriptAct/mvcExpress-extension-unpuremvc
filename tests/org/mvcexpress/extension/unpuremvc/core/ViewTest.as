...
package org.mvcexpress.extension.unpuremvc.core
{
	...
	public class ViewTest extends TestCase {
		...
		public function testRegisterAndRemoveMediator():void {
			...
			// Create and register the test mediator
			var mediator:IMediator = new UnpureMediator( 'testing', this );
			view.registerMediator( mediator );
		...
		{
			 UnpureView.getInstance().removeMediator( ViewTestMediator.NAME );
			 UnpureView.getInstance().removeMediator( ViewTestMediator2.NAME );
			 UnpureView.getInstance().removeMediator( ViewTestMediator3.NAME );
		}
 	}
}