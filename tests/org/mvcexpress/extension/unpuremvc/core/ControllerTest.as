		 ...
		 */
 		public static function suite():TestSuite {
  		...
  		public function testGetInstance():void {
   			...
   			// Test Factory Method
   			var controller:IController = UnpureController.getInstance();
  		...
  		public function testRegisterAndExecuteCommand():void {
   			...
   			var controller:IController = UnpureController.getInstance();
   			controller.registerCommand('ControllerTest', org.mvcexpress.extension.unpuremvc.core.ControllerTestCommand);
  		...
  		public function testRegisterAndRemoveCommand():void {
   			...
   			// Create the controller, register the ControllerTestCommand to handle 'ControllerTest' notes
   			var controller:IController = UnpureController.getInstance();
   			controller.registerCommand('ControllerRemoveTest', org.mvcexpress.extension.unpuremvc.core.ControllerTestCommand);
  		...
  		public function testHasCommand():void {
   			...
   			var controller:IController = UnpureController.getInstance();
   			controller.registerCommand('hasCommandTest', org.mvcexpress.extension.unpuremvc.core.ControllerTestCommand);
 		...
 		/**
  		...
  		public function testReregisterAndExecuteCommand():void {
   			...
   			var controller:IController = UnpureController.getInstance();
   			controller.registerCommand('ControllerTest2', org.mvcexpress.extension.unpuremvc.core.ControllerTestCommand2);
			...
			// retrieve a reference to the View.
   			var view:IView = UnpureView.getInstance();
