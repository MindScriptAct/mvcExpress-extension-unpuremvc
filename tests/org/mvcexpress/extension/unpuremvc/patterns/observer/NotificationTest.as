 		...
 		public static function suite():TestSuite {
  		...
  		public function testNameAccessors():void {
			...
			// Create a new Notification and use accessors to set the note name
   			var note:INotification = new UnpureNotification('TestNote');
  		...
  		public function testBodyAccessors():void {
			...
			// Create a new Notification and use accessors to set the body
   			var note:INotification = new UnpureNotification(null);
   			note.setBody(5);
  		...
  		public function testConstructor():void {
			...
			// Create a new Notification using the Constructor to set the note name and body
   			var note:INotification = new UnpureNotification('TestNote',5,'TestNoteType');
  		...
  		public function testToString():void {
			...
			// Create a new Notification and use accessors to set the note name
   			var note:INotification = new UnpureNotification('TestNote',[1,3,5],'TestType');
