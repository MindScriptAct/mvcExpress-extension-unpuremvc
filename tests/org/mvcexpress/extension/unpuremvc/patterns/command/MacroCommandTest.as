...
package org.mvcexpress.extension.unpuremvc.patterns.command
{
	import flexunit.framework.TestCase;
 	...
 	import org.mvcexpress.extension.unpuremvc.patterns.command.MacroCommandTestCommand;
 	import org.mvcexpress.extension.unpuremvc.patterns.command.MacroCommandTestVO;
 	...
 	public class MacroCommandTest extends TestCase {
		 ...
		 */
  		...
  		public function testMacroCommandExecute():void {
  			...
  			var note:INotification = new UnpureNotification('MacroCommandTest', vo);
