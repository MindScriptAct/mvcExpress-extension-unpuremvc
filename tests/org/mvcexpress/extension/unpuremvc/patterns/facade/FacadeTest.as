 	...
 	public class FacadeTest extends TestCase {
		 ...
		 */
  		...
  		public function testGetInstance():void {
   			...
   			// Test Factory Method
   			var facade:IFacade = UnpureFacade.getInstance();
  		...
  		public function testRegisterCommandAndSendNotification():void {
   			...
   			var facade:IFacade = UnpureFacade.getInstance();
   			facade.registerCommand('FacadeTestNote', org.mvcexpress.extension.unpuremvc.patterns.facade.FacadeTestCommand);
  		...
  		public function testRegisterAndRemoveProxy():void {
   			...
   			var facade:IFacade = UnpureFacade.getInstance();
   			var proxy:IProxy = new UnpureProxy('sizes', ['7', '13', '21'] );
  		...
  		public function testRegisterRetrieveAndRemoveMediator():void {
			...
			// remove the mediator
			var removedMediator:IMediator = facade.removeMediator(UnpureMediator.NAME);
  		...
  		public function testHasCommand():void {
   			...
   			var facade:IFacade = UnpureFacade.getInstance();
   			facade.registerCommand('facadeHasCommandTest', org.mvcexpress.extension.unpuremvc.patterns.facade.FacadeTestCommand);
